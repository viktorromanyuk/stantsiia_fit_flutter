...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/check-filled.svg
  SvgGenImage get checkFilled =>
      const SvgGenImage('assets/icons/check-filled.svg');
  ...
  /// File path: assets/icons/info-filled.svg
  SvgGenImage get infoFilled =>
      const SvgGenImage('assets/icons/info-filled.svg');
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/dance.png
  AssetGenImage get dance => const AssetGenImage('assets/images/dance.png');
  ...
  /// List of all assets
  List<AssetGenImage> get values => [dance, relax, train];
}
